...
of Sydney`_. I am advised by Assoc. Prof. `Fabio Ramos`_, jointly with `Edwin 
Bonilla`_ at UNSW and Prof. `Richard Nock`_ at ANU/Data61. My main research 
interests lie in variational Bayesian inference, generative models, deep 
learning and the intersection of these approaches.
...
Bayesian statistics. I still work there currently on a part-time basis.
