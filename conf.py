...
BLOG_AUTHOR = "Louis Tiao"  # (translatable)
...
TAG_PAGES_DESCRIPTIONS = {
   DEFAULT_LANG: {
       "mathjax": "Purdy LaTeX equations rendered by MathJax. Enjoy!",
   },
}
...
# <form id="search" action="//www.google.com/search" method="get" class="navbar-form navbar-right">
